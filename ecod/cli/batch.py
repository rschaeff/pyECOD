...
class BatchCommand(BaseCommand)
    ...
    def _create_batch(self, args: argparse.Namespace, db: DBManager, config_manager: ConfigManager) -> int:
    ...
    def _check_status(self, args: argparse.Namespace, db: DBManager) -> int:
        """Check batch status"""
    ...
    def _list_batches(self, args: argparse.Namespace, db: DBManager) -> int:
        """List all batches"""
        # Build query
        query = """
        SELECT 
    ...
    def _run_batch(self, args: argparse.Namespace, config_manager: ConfigManager) -> int:
