    ...
    def generate_test_config(self, proteins: List[Dict], output_file: str):
        ...
        for protein in proteins:
            ...
            lines.extend([
                ...
                f'        "estimated_length": {protein["length"]},',
                f'        "estimated_domains": {protein["estimated_domains"]},',
                f'        "evidence_total": {evidence["total"]},',
                f'        "chain_blast": {evidence["chain_blast"]},',
                f'        "domain_blast": {evidence["domain_blast"]},',
                f'        "hhsearch": {evidence["hhsearch"]},',
...
def main():
    ...
    for protein in selected:
        ...
        print(f"  Evidence: CB={protein['evidence']['chain_blast']}, "
              f"DB={protein['evidence']['domain_blast']}, "
              f"HH={protein['evidence']['hhsearch']}")
